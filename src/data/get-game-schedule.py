...
def FormatGamesDict(year, matchup_links, start_times_places, score_pairs, team_name_pairs):
...
def main():
    ...
    # Scrape Years of Games
        for url in GetGamePageURLs(year):
            soup = GetSoup(url) 
            ...
            game_info_dicts +=FormatGamesDict(year, matchup_links, start_times_places,
